...
import com.android.xuanhong.tryonglasses.models.entities.Camera;
import com.android.xuanhong.tryonglasses.models.model.Object3D;
...
import com.android.xuanhong.tryonglasses.models.util.GLUtil;
...
public class ModelRenderer implements GLSurfaceView.Renderer {
	...
	public void onDrawFrame(GL10 unused) {
		...
		LoaderScenes scene = main.getModelActivity().getScene();
		if (scene == null) {
			// scene not ready
			return;
		}
